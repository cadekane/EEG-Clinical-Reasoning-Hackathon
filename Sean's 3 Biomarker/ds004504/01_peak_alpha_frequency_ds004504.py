...
Input:  {BASE_DIR}/derivatives/eeglab/sub-XXX/eeg/sub-XXX_task-eyesclosed_eeg.set
...
def find_set_files(base_dir: str, subject: str = None) -> list:
    ...
    if subject:
        pattern = os.path.join(
            base_dir, "derivative", subject, "eeg",
...
def main():
    ...
    if not set_files:
        print(f"[ERROR] No .set files found under {base_dir}/derivatives/eeglab/")
        return
