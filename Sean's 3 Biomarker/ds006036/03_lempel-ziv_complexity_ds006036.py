...
Usage:
    python 03_lempel-ziv_complexity_ds006036.py --base_dir /path/to/ds006036
    python 03_lempel-ziv_complexity_ds006036.py --base_dir /path/to/ds006036 --subject sub-001
...
# Binarisation method: "median" | "mean" | "zero"
...
def main():
    parser = argparse.ArgumentParser(
        description="Extract Lempel-Ziv Complexity from ds006036 EEG dataset."
    )
